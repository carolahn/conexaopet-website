export const mockProtectorData = {
  ...
  celular: '41999991234',
  descricao: 'Cuido de mais de 300 animais.\nAdote e, se não puder, ajude a divulgar os peludos.',
  pix: 'protetorpaulo@gmail.com',
};

export const mockProtectorAnimals = [
  {
    id: 1,
    nome: 'Fido',
    cidade: 'Curitiba',
...
export const mockProtectorEvents = [
  {
    id: 1,
    protetor: {
      imagem: 'https://via.placeholder.com/200',
